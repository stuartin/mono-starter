...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'Mutation': { kind: 'OBJECT'; name: 'Mutation'; fields: { 'login': { name: 'login'; type: { kind: 'OBJECT'; name: 'User'; ofType: null; } }; 'logout': { name: 'logout'; type: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; } }; 'register': { name: 'register'; type: { kind: 'OBJECT'; name: 'User'; ofType: null; } }; }; };
